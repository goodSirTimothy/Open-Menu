...
public class EditWeeklySpecial implements Initializable {
    ...
    private void onEdit() {
        ...
        if (weeklyTable.getSelectionModel().getSelectedItem() != null) {
            ...
            dialogEditRoom(selectedItem.getDayID(), selectedItem.getItemName(), selectedItem.getItemDescription(), selectedItem.getItemID(), 1);
     ...
     */
    private void dialogEditRoom(String dayID, String itemName, String itemDescription, String itemID, int controller){
    ...
    private void dialogAdminLogin(String dayID, String itemName, String itemDescription){
        // Create the custom dialog.
        Dialog<Pair<String, String>> dialog = new Dialog<>();
        ...
        dialog.setResultConverter(dialogButton -> {
            ...
            if (dialogButton == submitButtonType) {
                ...
                String mysqlQuery = "INSERT IGNORE INTO weeklySpecial(dayID, itemName, itemDescription) " +
                        "VALUES (?, ?, ?)";
                query.rootQuery(mysqlQuery, rootUser.getText(), rootPass.getText(), dayID, itemName, itemDescription);
            }
            return null;
        });
        // showAndWait() is the last method to be called, because it displays the dialog box.
